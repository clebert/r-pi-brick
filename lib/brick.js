...
exports.initAsync = function (timeout) {
    try {
...
var transmitAsync = function (address, retries, maxRetries) {
    try {
        ...
        return serialPort.writeAsync(data).then(serialPort.readAsync).then(function (data) {
            if (data) {
                ...
                return transmitAsync(address, retries + 1, maxRetries);
            }
        });
    } catch (error) {
        return Promise.reject(error);
...
exports.updateAsync = function (maxRetries) {
    try {
        ...
        return transmitAsync(1, 0, maxRetries).then(function () {
            return transmitAsync(2, 0, maxRetries);
        }).then(function () {
            inProgress = false;
