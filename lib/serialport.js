...
exports.SerialPort = function (timeout) {
    ...
    this.openAsync = denodeify(serialPort.open.bind(serialPort));
    ...
    var drain = denodeify(serialPort.drain.bind(serialPort));
    var write = denodeify(serialPort.write.bind(serialPort));
